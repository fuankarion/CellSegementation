...
def SemanticEval(params):
    ...
    with open('../Hough/Stage1_hough_CORRECT.csv','a') as f:
        f.write('mindists:' + str(params[0]) +' ,param2:' + str(params[1]) +' ,minRadius:' +  str(params[2]) + ' ,Mean Jaccard: ' + str(meanJaccard)+ '\n')

processPool = mp.Pool(5)
mindist = np.array((40,50,60,70))
param2 = np.array((10,20,30,40))
minRadius = np.array((70,80,90,100,110))
params = []
for d in mindist:
    for p in param2:
        for r in minRadius:
